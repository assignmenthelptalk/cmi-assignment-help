...
function isInfographicLabel(text) {
  return /^(TRUST BADGE|LEVEL SELECTOR|PROCESS INFOGRAPHIC|PROCESS TIMELINE|LEVEL COMPARISON|CMI COMMAND VERB|CMI MANAGEMENT REPORT|GIBBS REFLECTIVE|UNIT INFO BADGE|LEADERSHIP THEORIES)/i.test(text);
}
