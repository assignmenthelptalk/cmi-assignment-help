...
Conflicting stakeholder expectations represent the most complex management challenge in the unit. A single paragraph signals to the assessor that the student has run out of word count. AC3 requires the same Evaluate depth as AC1 and AC2.

**4. No specific management scenario**
Stakeholder management in the abstract produces a report with no evaluative grounding. The power and interest positions of stakeholders are determined by the specific management context. Without a defined scenario, the evaluation is speculative rather than applied.

**5. Freeman's definition absent from AC1**
The definitional scope of stakeholders is the conceptual foundation of AC1. Reports that move directly to the matrix without establishing this foundation miss the analytical starting point of the criterion.
...
**CMI 509 tutoring** — We plan your AC structure and management scenario, guide your framework selection and Evaluate approach for each criterion, and provide feedback on your draft. [View CMI assignment tutoring](/cmi-assignment-tutoring/)
